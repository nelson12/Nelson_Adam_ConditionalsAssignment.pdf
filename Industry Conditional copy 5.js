...
(temp>102 || pain>6) ? console.log("See your Doctor immediately or go to the ER!"):console.log("Take a pain pill or a Tylenol and get some rest.");//declaring what to do if false